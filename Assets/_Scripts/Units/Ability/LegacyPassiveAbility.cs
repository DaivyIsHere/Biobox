...
[CreateAssetMenu(fileName = "NewPassiveAbility", menuName = "Biobox/Ability/LegacyPassiveAbility", order = 1)]
public class LegacyPassiveAbility : ScriptableAbility
{
    //Editor Cache
...
#region Editor
#if UNITY_EDITOR
[CustomEditor(typeof(LegacyPassiveAbility))]
public class PassiveAbilityEditor : Editor
{
    private LegacyPassiveAbility script;
    ...
    void OnEnable()
    {
        script = (LegacyPassiveAbility)target;
